      ...
      <section>
        ...
        <div className="diamond_container">
          ...
          <div className="group_diamond">
            <Link to="/" className="Rectangle_2876 top">
              <p className="rectangle_label">Demographics</p>
            </Link>
            <Link to="/" className="Rectangle_2876 bottom">
              <p className="rectangle_label">Weather</p>
              </Link>
            <Link to="/" className="Rectangle_2876 left">
              <p className="rectangle_label">
                Skin Type <br />
                Details
              </p>
              </Link>
            <Link to="/" className="Rectangle_2876 right">
